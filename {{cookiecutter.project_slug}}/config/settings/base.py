...
APP_DIR = BASE_DIR / "{{cookiecutter.project_slug}}"
...
# }
DATABASES = {
    'default': env.db('DATABASE_URL', default='psql://{{ cookiecutter.author_name.split(' ')[0] }}:{{ cookiecutter.password }}@127.0.0.1:5432/{{cookiecutter.project_slug}}'),
}
